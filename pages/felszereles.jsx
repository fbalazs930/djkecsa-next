        ...
        <div className="equipment">
            ...
            <div className="items">
                <div className="item">
                    ...
                    <div className="img">
                        <Image loader={myLoader} alt="Turbosound Milan M12" layout="fill" src={TurbosoundMilanM12} />
                    </div>
                </div>
                <div className="item">
                    <div>JBL PRX PRX618S-XLF aktív mélyláda</div>
                    <div className="img">
                        <Image loader={myLoader} alt="JBL PRX PRX618S-XLF" layout="fill" src={JBLPRXPRX618SXLF} />
                    </div>
                </div>
                <div className="item">
                    <div>DBX driverack pa2 rendeszvezérlő processzor</div>
                    <div className="img">
                        <Image loader={myLoader} alt="DBX driverack pa2" layout="fill" src={DBXdriverackpa2} />
                    </div>
                </div>
                <div className="item">
                    <div>Pioneer DDJ-1000 Dj szoftver vezérlő</div>
                    <div className="img">
                        <Image loader={myLoader} alt="Pioneer DDJ-1000" layout="fill" src={PioneerDDJ1000Dj} />
                    </div>
                </div>
                <div className="item">
                    <div>Macbook Pro 13” 2019</div>
                    <div className="img">
                        <Image loader={myLoader} alt="Macbook Pro 13 2019" layout="fill" src={macbook} />
                    </div>
                </div>
                <div className="item">
                    <div>Teremszinező PAR lámpa</div>
                    <div className="img">
                        <Image loader={myLoader} alt="PAR lampa" layout="fill" src={par} />
                    </div>
                </div>
                <div className="item">
                    <div>Cameo Hydrabeam 1000 RGBW</div>
                    <div className="img">
                        <Image loader={myLoader} alt="Cameo Hydrabeam 1000 RGBW" layout="fill" src={CameoHydrabeam1000RGBW} />
                    </div>
                </div>
                <div className="item">
                    <div>EUROLITE - LED TMH-13 Moving-Head Spot</div>
                    <div className="img">
                        <Image loader={myLoader} alt="EUROLITE - LED TMH-13 Moving-Head Spot" layout="fill" src={EUROLITELEDTMH13MovingHeadSpot} />
                    </div>
                </div>
                <div className="item">
                    <div>EUROLITE - LED BAR-6 QCL RGBW Bar</div>
                    <div className="img">
                        <Image loader={myLoader} alt="EUROLITE - LED BAR-6 QCL RGBW Bar" layout="fill" src={EUROLITELEDBAR6QCLRGBWBar} />
                    </div>
                </div>
                <div className="item">
                    <div>EUROLITE - LED Party UV Bar 9</div>
                    <div className="img">
                        <Image loader={myLoader} alt="EUROLITE - LED Party UV Bar 9" layout="fill" src={EUROLITELEDPartyUVBar9} />
                    </div>
                </div>
                <div className="item">
                    <div>Involtight FOG1200</div>
                    <div className="img">
                        <Image loader={myLoader} alt="Involtight FOG1200" layout="fill" src={InvoltightFOG1200} />
                    </div>
                </div>
                <div className="item">
                    <div>Cerebellum digi 128M fényvezérlő</div>
                    <div className="img">
                        <Image loader={myLoader} alt="Cerebellum digi 128M" layout="fill" src={Cerebellumdigi128M} />
                    </div>
                </div>
            </div>
