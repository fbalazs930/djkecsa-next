        ...
        <div className="equipment">
            ...
            <div className="items">
                ...
                <div className="item">
                    ...
                    <div className="img">
                        <Image alt="Macbook Pro 13 2019" layout="fill" src="https://i.postimg.cc/SQvzMMy8/image-removebg-preview-1.png" />
                    </div>
                </div>
                <div className="item">
                ...
                <div className="item">
                    ...
                    <div className="img">
                        <Image alt="EUROLITE - LED BAR-6 QCL RGBW Bar" layout="fill" src="https://i.postimg.cc/sXF3z3yM/image-removebg-preview-5.png" />
                    </div>
                </div>
                <div className="item">
                    <div>EUROLITE - LED Party UV Bar 9</div>
                    <div className="img">
                        <Image alt="EUROLITE - LED Party UV Bar 9" layout="fill" src="https://i.postimg.cc/Hnzmb5MM/image-removebg-preview-6.png" />
                    </div>
                </div>
                <div className="item">
                    <div>Involtight FOG1200</div>
                    <div className="img">
                        <Image alt="Involtight FOG1200" layout="fill" src="https://i.postimg.cc/rwKTtDwd/image-removebg-preview-7.png" />
                    </div>
                </div>
                <div className="item">
                    <div>Cerebellum digi 128M fényvezérlő</div>
                    <div className="img">
                        <Image alt="Cerebellum digi 128M" layout="fill" src="https://i.postimg.cc/fLs15yDf/image-removebg-preview-8.png" />
                    </div>
                </div>
            </div>
